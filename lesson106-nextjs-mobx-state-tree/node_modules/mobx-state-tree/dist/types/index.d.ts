...
export { IType, ISimpleType, IComplexType, IModelType, ISnapshottable, IExtendedObservableMap, TypeFlags, typecheckPublic };
export declare const types: {
    ...
    compose: {
        <T1, S1, T2, S2, T3, S3>(t1: IModelType<T1, S1>, t2: IModelType<T2, S2>, t3?: IModelType<T3, S3> | undefined): IModelType<T1 & T2 & T3, S1 & S2 & S3>;
        <T1, S1, A1, T2, S2, A2, T3, S3, A3>(name: string, t1: IModelType<T1, S1>, t2: IModelType<T2, S2>, t3?: IModelType<T3, S3> | undefined): IModelType<T1 & T2 & T3, S1 & S2 & S3>;
    };
    ...
    refinement: {
        <T>(name: string, type: IType<T, T>, predicate: (snapshot: T) => boolean, message?: string | ((v: any) => string) | undefined): IType<T, T>;
        <S, T extends S, U extends S>(name: string, type: IType<S, T>, predicate: (snapshot: S) => snapshot is U, message?: string | ((v: any) => string) | undefined): IType<S, U>;
        <S, T extends S, U extends S>(type: IType<S, T>, predicate: (snapshot: S) => snapshot is U, message?: string | ((v: any) => string) | undefined): IType<S, U>;
        <T>(type: IType<T, T>, predicate: (snapshot: T) => boolean, message?: string | ((v: any) => string) | undefined): IType<T, T>;
    };
