...
import * as PostActions from '../../../modules/lesson15/reduxThunk/Post.jsx';
...
export default connect(
	state => ({
		number: state.ModulesReducers.postThunk.get('num'),
		post: state.ModulesReducers.postThunk.get('data').toJS(),
		loading: state.ModulesReducers.postThunk.get('pending'),
		error: state.ModulesReducers.postThunk.get('error')
	}),
	dispatch => ({
