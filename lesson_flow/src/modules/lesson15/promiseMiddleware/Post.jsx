...
export const GET_POST = '/lesson15/promiseMiddleware/GET_POST';
export const GET_POST_PENDING = '/lesson15/promiseMiddleware/GET_POST_PENDING';
export const GET_POST_SUCCESS = '/lesson15/promiseMiddleware/GET_POST_SUCCESS';
export const GET_POST_FAILURE = '/lesson15/promiseMiddleware/GET_POST_FAILURE';
const SET_INCREMENT = 'lesson15/promiseMiddleware/SET_INCREMENT';
const SET_DECREMENT = 'lesson15/promiseMiddleware/SET_DECREMENT';
